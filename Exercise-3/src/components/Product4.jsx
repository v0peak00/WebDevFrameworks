    ...
    return (
        ...
        <Container>
            ...
            <Rating>
                ...
                <Ratings>{products[3].ratingCount}</Ratings>
            </Rating>
            <Price> 
                $
                <PriceSpan1>{products[3].priceWhole}</PriceSpan1>
                <PriceSpan2>{products[3].priceFraction}</PriceSpan2>
            </Price>
            <Shipping>
                <ShippingDesc>
                {products[3].shippingDef}
                </ShippingDesc>
            <ShippingDate>
                {products[3].shippingDate}
            </ShippingDate>
            </Shipping> 
            <ShippingPrice>${products[3].shippingPrice} shipping</ShippingPrice>
            </Desc>
